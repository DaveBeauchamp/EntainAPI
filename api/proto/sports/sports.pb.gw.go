...
func request_Racing_ListEvents_0(ctx context.Context, marshaler runtime.Marshaler, client RacingClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterRacingHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RacingClient) error {
	...
	mux.Handle("POST", pattern_Racing_ListEvents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Racing_ListEvents_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Racing_ListEvents_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Racing_ListEvents_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "list-events"}, ""))
)

var (
	forward_Racing_ListEvents_0 = runtime.ForwardResponseMessage
)
